...
import { StyleSheet, View, Text, Image, Dimensions, ScrollView, StatusBar } from 'react-native';
...
const gradesDistribution = [{ grade: 2, value: 0.3 }, { grade: 3, value: 0.5 }, { grade: 3.5, value: 0.7 }, { grade: 4, value: 0.8 }, { grade: 4.5, value: 0.9 }, { grade: 5, value: 1 }, { grade: 5.5, value: 0.6 }];

const screenWidth = Dimensions.get('window').width;
const imageUrl = '../../assets/gebala_portret.jpg';

export default function ViewLecturerScreen({ navigation }: MainNavigationProps) {
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.scrollContainerContent}>
        ...
        <Progress.Bar progress={lecturerExperience} width={screenWidth * 0.9} height={10} />
        ...
        <View>
          {gradesDistribution.map(item => (
            <View key={item.grade} style={styles.gradeRow}>
              ...
              <Progress.Bar progress={item.value} width={0.6 * screenWidth} height={10} />
            </View>
          ))}
        </View>
      </ScrollView>
